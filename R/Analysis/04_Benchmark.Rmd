...
multilabel_k %>% 
  cowplot::save_plot(plot = .,
                     filename = here::here('figures', 'benchmark_multilabel_boxplot_kappa.pdf'),
                     dpi = 450,
                     bg = 'transparent'
                     )
...
binary_k %>% 
    cowplot::save_plot(plot = .,
                     filename = here::here('figures', 'benchmark_binary_boxplot_kappa.pdf'),
                     dpi = 450,
                     bg = 'transparent'
                     )
...
multi_binary_combined %>% 
      cowplot::save_plot(plot = .,
                     filename = here::here('figures', 'benchmark_combined_boxplot_kappa.pdf'),
                     dpi = 450,
                     bg = 'transparent'
                     )
